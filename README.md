...
```bash
  ...
  ├────────────────────────────────────────────────────────────────────────────────────────────────┤
  │ ✔  enumerators.cy.ts                        00:18       19       19        -        -        - │
  ├────────────────────────────────────────────────────────────────────────────────────────────────┤
  │ ✔  event-viewer.cy.ts                       735ms        3        3        -        -        - │
  ├────────────────────────────────────────────────────────────────────────────────────────────────┤
  ...
  ├────────────────────────────────────────────────────────────────────────────────────────────────┤
  │ ✔  type.root.object.cy.ts                   00:57       16       16        -        -        - │
  ├────────────────────────────────────────────────────────────────────────────────────────────────┤
  │ ✔  type.simple.cy.ts                        00:13        5        5        -        -        - │
  ├────────────────────────────────────────────────────────────────────────────────────────────────┤
  │ ✖  user.journey1.cy.ts                      00:01       14        -       14        -        - │
  └────────────────────────────────────────────────────────────────────────────────────────────────┘
    ✖  2 of 23 failed (9%)                      10:26      254      228       26        -        -  
```
