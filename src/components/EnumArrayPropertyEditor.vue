<template>
  <div class="enum-array-property-editor">
        ...
        <div class="array-controls mt-4">
          <v-card variant="outlined" class="pa-3">
            <div class="d-flex align-center justify-space-between mb-2">
              <span class="text-subtitle-2 font-weight-bold">Array Settings</span>
              <v-chip color="info" variant="outlined" size="small">
                Array of Enums
              </v-chip>
            </div>
            <p class="text-caption text-medium-emphasis">
              This property will be an array of the selected enum values.
            </p>
          </v-card>
        </div>
      </div>
    ...
    <!-- Top-level layout for root enum arrays -->
    ...
    <div v-if="props.topLevel" class="array-controls mt-4">
      <v-card variant="outlined" class="pa-3">
        <div class="d-flex align-center justify-space-between mb-2">
          <span class="text-subtitle-2 font-weight-bold">Array Settings</span>
          <v-chip color="info" variant="outlined" size="small">
