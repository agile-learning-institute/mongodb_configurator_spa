<template>
  <div class="type-array-of-array-property-editor">
...
import { useTypeArrayOfArrayPropertyEditor } from '@/composables/useTypeArrayOfArrayPropertyEditor'
...
const itemsType = computed({
  get() {
    return props.property.items?.type || 'array'
  },
  set(type: string) {
...
<style scoped>
.type-array-of-array-property-editor {
  width: 100%;
