describe('Configurations page flow', () => {
  ...
  describe('Step 5 Index Management', () => {
    it.only('can add, edit, and remove Step 5 indexes', () => {
      ...
      cy.get('[data-test="step5-index-json-textarea"] textarea').eq(1).should('contain', '"name": ""')
      cy.get('[data-test="step5-index-json-textarea"] textarea').eq(1).should('contain', '"key": {}')
      cy.get('[data-test="step5-index-json-textarea"] textarea').eq(1).should('contain', '"options": {}')
      ...
      cy.get('[data-test="step5-index-json-textarea"] textarea').eq(1).should('contain', '"name": "name1"')
