...
describe('Dictionary Details Page', () => {
  ...
  describe('Lockable One_Of Property Editor', () => {
    it('locks', () => {
      ...
      // Make sure the property name and description are locked (One Of property at index 1)
    ...
    it('unlocks', () => {
      ...
      // Make sure the property name and description are unlocked (One Of property at index 1)
