...
describe('Dictionary Details Page', () => {
  ...
  describe('Enum Property Editor', () => {
    it('can persist name/description edits', () => {
      ...
      // Target the Enum property (index 1, after root _id) - clear first
    ...
    it('locks', () => {
      ...
      // Make sure the property name and description are locked (Enum property at index 1)
    ...
    it('unlocks', () => {
      ...
      // Make sure the property name and description are unlocked (Enum property at index 1)
