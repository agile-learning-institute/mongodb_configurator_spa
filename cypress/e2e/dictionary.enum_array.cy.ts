...
describe('Dictionary Details Page', () => {
  ...
  describe('Enum Array Property Editor', () => {
    ...
    it('locks', () => {
      ...
      // Make sure the property name and description are locked (Enum Array property at index 1)
    ...
    it('unlocks', () => {
      ...
      // Make sure the property name and description are unlocked (Enum Array property at index 1)
